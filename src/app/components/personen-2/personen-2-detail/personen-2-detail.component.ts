...
@Component({
  selector: 'app-personen-2-detail',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './personen-2-detail.component.html',
  styleUrl: './personen-2-detail.component.scss'
})
export class Personen2DetailComponent {
  ...
  private initializeForm(): void {
    this.personForm = this.fb.group({
      ...
      emailGeschaeftlich: [{ value: '', disabled: true }, [Validators.required, Validators.email, Personen2DetailComponent.emailPatternValidator]],
      emailExtern: [{ value: '', disabled: true }, [Validators.email, Personen2DetailComponent.emailPatternValidator]],
    ...
    saveObservable
      ...
      .subscribe({
        next: (savedPerson: ApiPerson) => {
          ...
          if (!this.personId) {
            this.router.navigate(['/personen-2', savedPerson.id]);
          }
        },
        error: (error) => {
  ...
  onBack(): void {
    ...
    this.router.navigate(['/personen-2']);
  }
